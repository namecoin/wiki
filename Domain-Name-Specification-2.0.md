...
This is a DRAFT proposal for an extended specification for the domain application of [[Namecoin]]. In the meantime, [[HowToRegisterAndConfigureBitDomains|you can configure your domain with the current specification]].

Please join in with your ideas [[Talk:Domain names|here]], on the [http://dot-bit.org/forum/index.php forum] or the IRC (<tt>#namecoin@freenode</tt>).
